...
(function(exports) {
  ...
  var taskEditableLabel = function (chan) {
      return function (task) {
          if (task.editing) {
              return Incremental_Elements.input([ Incremental_Attributes["type'"]("text"), Incremental_Attributes.value(task.description), Incremental_Attributes["class'"]("task-description"), Incremental_Attributes["onInput'"](function (_5) {
                  return Signal_Channel.send(chan)(Action.ChangeDescription.create(task.taskId)(Incremental_Attributes.targetValue(_5)));
      ...
      return function (tasks) {
          ...
          return Incremental_Elements["div'"]([ Incremental_Attributes["class'"]("task-list-footer") ])(function __do() {
              ...
              return Incremental_Elements["div'"]([ Incremental_Attributes["class'"]("task-stats") ])(function __do() {
                  Incremental_Elements["span'"]([ Incremental_Attributes["class'"]("total") ])(Incremental_DOM.text("Total: " + Prelude.show(Prelude.showInt)(Data_List.length(tasks))))();
  ...
  var todoList = function (chan) {
      return function (state) {
          ...
          var filteredTasks = (function () {
              ...
              throw new Error("Failed pattern match at Components.TodoList line 19, column 1 - line 20, column 1: " + [  ]);
          })();
